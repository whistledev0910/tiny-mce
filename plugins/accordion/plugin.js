...
(function () {
    ...
    const global$3 = tinymce.util.Tools.resolve('tinymce.PluginManager');
    ...
    const global$1 = tinymce.util.Tools.resolve('tinymce.html.Node');
    ...
    const global = tinymce.util.Tools.resolve('tinymce.util.VK');
