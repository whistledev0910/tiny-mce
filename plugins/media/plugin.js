...
(function () {
    ...
    const global$6 = tinymce.util.Tools.resolve('tinymce.PluginManager');
    ...
    const global$3 = tinymce.util.Tools.resolve('tinymce.html.DomParser');
    ...
    const global$2 = tinymce.util.Tools.resolve('tinymce.html.Node');

    const global$1 = tinymce.util.Tools.resolve('tinymce.html.Serializer');
    ...
    const global = tinymce.util.Tools.resolve('tinymce.Env');
