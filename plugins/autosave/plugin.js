...
(function () {
    ...
    const global$4 = tinymce.util.Tools.resolve('tinymce.PluginManager');
    ...
    const global$2 = tinymce.util.Tools.resolve('tinymce.util.LocalStorage');
    ...
    const global = tinymce.util.Tools.resolve('tinymce.EditorManager');
