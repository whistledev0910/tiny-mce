...
(function () {
    ...
    const global$7 = tinymce.util.Tools.resolve('tinymce.PluginManager');
    ...
    const ClosestOrAncestor = (is, ancestor, scope, a, isRoot) => {
      if (is(scope, a)) {
    ...
    const global$6 = tinymce.util.Tools.resolve('tinymce.dom.RangeUtils');

    const global$5 = tinymce.util.Tools.resolve('tinymce.dom.TreeWalker');
    ...
    const global$1 = tinymce.util.Tools.resolve('tinymce.dom.BookmarkManager');
    ...
    const global = tinymce.util.Tools.resolve('tinymce.html.Node');
