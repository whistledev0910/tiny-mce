...
(function () {
    ...
    const global$1 = tinymce.util.Tools.resolve('tinymce.ModelManager');
    ...
    const platform = cached(() => PlatformDetection.detect(navigator.userAgent, Optional.from(navigator.userAgentData), mediaMatch));
    ...
    const global = tinymce.util.Tools.resolve('tinymce.FakeClipboard');
